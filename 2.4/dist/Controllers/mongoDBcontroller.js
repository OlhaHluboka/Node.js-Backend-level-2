...
exports.deleteItemInDB = exports.editItemInDB = exports.addItemInDB = exports.addUser = exports.getUser = exports.todoCounter = exports.todoItems = void 0;
const mongodb_1 = require("mongodb");
const urlMongo = "mongodb://127.0.0.1:27017/";
const client = new mongodb_1.MongoClient(urlMongo);
exports.todoItems = client.db("todo").collection("items");
exports.todoCounter = client.db("todo").collection("counter");
let todoCount;
/**
